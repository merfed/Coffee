...
public class LERandomAccessFile implements DataInput, DataOutput, Closeable {
	...
	public String toString() {
		...
		builder.append("LERandomAccessFile [raf=").append(raf).append(", work=").append(Arrays.toString(work))
				.append(", fileName=").append(fileName).append(", getFilePointer()=");

		try {
			builder.append(getFilePointer());
		} catch (IOException e) {
			e.printStackTrace();
		}
