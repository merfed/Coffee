...
public:
	...
	public:
		...
		// 
		std::vector< M2Lib::CM2Skin::CElement_Material* > pMaterials;
...
public:
	...
	bool Build( M2Lib::CM2Skin* pResult, UInt32 BoneLoD, M2Lib::CM2I* pM2I, M2Lib::CVertex* GlobalVertexList, UInt32 BoneStart );
